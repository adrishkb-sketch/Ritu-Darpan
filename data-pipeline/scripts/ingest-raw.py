...
def process_imd_binary(year, var_type, raw_dir):
    ...
    """
    print(f"Ingesting IMD {var_type} data for {year}...")
    
    # imdlib automatically handles the IMD grid layout (0.25 for rain, 1.0 for temp)
    # It expects files to be stored in a specific local directory structure
